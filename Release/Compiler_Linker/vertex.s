...
.Ltmp0:
	...
	ADDI r4, r0, gtf_ModelViewProjectionMatrix.u.0.4@ha
	ADDI r14, r4, gtf_ModelViewProjectionMatrix.u.0.4@l
	BL OpenGLES.LoadAttribute4.gtf_Color.0 # size:4
	ADDI R3, R2, 25		# ADDI r0, r1, 25 set_mark
	ADD R3, R3, R0		# ADD R3, R0, R0 set_mark_2
	NOP 9
	STV R16, 0(R3), <4>		# STV R16, 0(R3), <4> set_mark
	ADDI r5, r0, 1
	ADDI r6, r0, gtf_ModelViewProjectionMatrix.u.0.4@l
	ADDI r7, r0, 3
	ADD 7.1000, R14, R7
	LDV R7.1111, 0(7), <4>          # size:4
	ADDI R3, R2, 29		# ADDI r0, r1, 29 set_mark
	ADD R3, R3, R0		# ADD R3, R0, R0 set_mark_2
	NOP 9
	STV R7, 0(R3), <4>		# STV R7, 0(R3), <4> set_mark
	ADDI r7, r0, 2
	ADD 7.1000, R14, R7
	LDV R7.1111, 0(7), <4>          # size:4
	ADDI R3, R2, 28		# ADDI r0, r1, 28 set_mark
	ADD R3, R3, R0		# ADD R3, R0, R0 set_mark_2
	NOP 9
	STV R7, 0(R3), <4>		# STV R7, 0(R3), <4> set_mark
	ADD 14.1000, R14, R5
	LDV R14.1111, 0(14), <4>        # size:4
	ADDI r4, r0, gtf_ModelViewProjectionMatrix.u.0.4@ha
	ADD 4.1000, R4, R6
	LDV R4.1111, 0(4), <4>          # size:4
	ADDI R3, R2, 27		# ADDI r0, r1, 27 set_mark
	ADD R3, R3, R0		# ADD R3, R0, R0 set_mark_2
	NOP 9
	STV R4, 0(R3), <4>		# STV R4, 0(R3), <4> set_mark
	ADDI R3, R2, 29		# ADDI r0, r1, 29 set_mark        # size:4
	ADD R15.1000, R3, R0		# ADD R15.1000, R0, R0 set_mark_2
	LDV R15.1111, 0(15), <4>        # size:4
	ADDI R3, R2, 28		# ADDI r0, r1, 28 set_mark        # size:4
	ADD R16.1000, R3, R0		# ADD R16.1000, R0, R0 set_mark_2
	LDV R16.1111, 0(16), <4>        # size:4
	MVR r17.1111, r14.xyzw, <4>     # size:4
	ADDI R3, R2, 27		# ADDI r0, r1, 27 set_mark        # size:4
	ADD R18.1000, R3, R0		# ADD R18.1000, R0, R0 set_mark_2
	LDV R18.1111, 0(18), <4>        # size:4
	BL OpenGLES.ChangeMatrix4.1     # size:4
	ADDI R3, R2, 24		# ADDI r0, r1, 24 set_mark
	ADD R3, R3, R0		# ADD R3, R0, R0 set_mark_2
	NOP 9
	STV R16, 0(R3), <4>		# STV R16, 0(R3), <4> set_mark
	ADDI R3, R2, 29		# ADDI r0, r1, 29 set_mark        # size:4
	...
	ADDI R3, R2, 23		# ADDI r0, r1, 23 set_mark
	ADD R3, R3, R0		# ADD R3, R0, R0 set_mark_2
	NOP 9
	STV R16, 0(R3), <4>		# STV R16, 0(R3), <4> set_mark
	ADDI r4, r0, .LCPI0_0@ha
	LDV R3.1000, .LCPI0_0@l(4) 		# LDV R3.1000, .LCPI0_0@l(4) set_mark_4
	MVR R4.1000, R3.xyzw, <4>
	NOP 9
	STV r4.1000, 22(1), <1>		# STV r4.1000, 22(1), <1> set_mark_4
	ADDI R3, R2, 29		# ADDI r0, r1, 29 set_mark        # size:4
	ADD R15.1000, R3, R0		# ADD R15.1000, R0, R0 set_mark_2
	LDV R15.1111, 0(15), <4>        # size:4
	ADDI R3, R2, 28		# ADDI r0, r1, 28 set_mark        # size:4
	...
	ADDI R3, R2, 21		# ADDI r0, r1, 21 set_mark
	ADD R3, R3, R0		# ADD R3, R0, R0 set_mark_2
	NOP 9
	STV R16, 0(R3), <4>		# STV R16, 0(R3), <4> set_mark
	ADDI r5, r0, .LCPI0_1@ha
	LDV R3.1000, .LCPI0_1@l(5) 		# LDV R3.1000, .LCPI0_1@l(5) set_mark_4
	MVR R5.1000, R3.xyzw, <4>
	NOP 9
	STV r5.1000, 20(1), <1>		# STV r5.1000, 20(1), <1> set_mark_4
	ADDI R3, R2, 29		# ADDI r0, r1, 29 set_mark        # size:4
	ADD R15.1000, R3, R0		# ADD R15.1000, R0, R0 set_mark_2
	LDV R15.1111, 0(15), <4>        # size:4
	ADDI R3, R2, 28		# ADDI r0, r1, 28 set_mark        # size:4
	...
	ADDI r6, r1, 31
	NOP 9
	STV r6, 28(1), <1>		# STV r6, 28(1), <1> set_mark_4
	...
	LDV R3.1000, .LCPI0_2@l(7) 		# LDV R3.1000, .LCPI0_2@l(7) set_mark_4
	MVR R7.1000, R3.xyzw, <4>
	NOP 9
	STV r7.1000, 27(1), <1>		# STV r7.1000, 27(1), <1> set_mark_4
	MVR r15.1111, r14.xyzw, <4>     # size:4
	ADDI R3, R2, 29		# ADDI r0, r1, 29 set_mark        # size:4
	ADD R16.1000, R3, R0		# ADD R16.1000, R0, R0 set_mark_2
	LDV R16.1111, 0(16), <4>        # size:4
	ADDI R3, R2, 21		# ADDI r0, r1, 21 set_mark        # size:4
	ADD R17.1000, R3, R0		# ADD R17.1000, R0, R0 set_mark_2
	LDV R17.1111, 0(17), <4>        # size:4
	ADDI R3, R2, 23		# ADDI r0, r1, 23 set_mark        # size:4
	ADD R18.1000, R3, R0		# ADD R18.1000, R0, R0 set_mark_2
	LDV R18.1111, 0(18), <4>        # size:4
	ADDI R3, R2, 24		# ADDI r0, r1, 24 set_mark        # size:4
	ADD R19.1000, R3, R0		# ADD R19.1000, R0, R0 set_mark_2
	...
	NOP 9
	STV R16, 0(R3), <4>		# STV R16, 0(R3), <4> set_mark
	ADDI r4, r0, gl_PointSize@ha
	LDV R3.1000, gl_PointSize@l(4) 		# LDV R3.1000, gl_PointSize@l(4) set_mark_4
	MVR R5.1000, R3.xyzw, <4>
	ADDI R3, R2, 29		# ADDI r0, r1, 29 set_mark        # size:4
	ADD R8.1000, R3, R0		# ADD R8.1000, R0, R0 set_mark_2
	LDV R8.1111, 0(8), <4>          # size:4
	LDV R6.1000, 28(1)              # size:4
	ADD R3, R0, R6
	NOP 9
	STV R8, 0(R3), set_mark_3		# STV R8, 0(R3) set_mark_3        # size:4
	LDV R3.1000, 22(1) 		# LDV R3.1000, 22(1) set_mark_4
	MVR R6.1000, R3.xyzw, <4>
	MULF r5, r5, r6
	LDV R3.1000, 20(1) 		# LDV R3.1000, 20(1) set_mark_4
	MVR R6.1000, R3.xyzw, <4>
	ADDF r5, r5, r6
	NOP 9
	STV r5.1000, gl_PointSize@l(4), <1>		# STV r5.1000, gl_PointSize@l(4), <1> set_mark_4
	LDV R3.0001, 31(1) 		# LDV R3.0001, 31(1) set_mark_4
	MVR R14.1000, R3.wyzw, <4>      # size:4
	ADDI r4, r1, 30
	NOP 9
	STV r4, 28(1), <1>		# STV r4, 28(1), <1> set_mark_4
	ADDI R3, R2, 25		# ADDI r0, r1, 25 set_mark        # size:4
	ADD R15.1000, R3, R0		# ADD R15.1000, R0, R0 set_mark_2
	LDV R15.1111, 0(15), <4>        # size:4
	...
	STV R16, 0(R3), <4>		# STV R16, 0(R3), <4> set_mark
	NOP 9
	STV r14.1000, 30(1), <1>		# STV r14.1000, 30(1), <1> set_mark_4 # size:4
	LDV R4.1000, 28(1)              # size:4
	ADD 14.1000, R0, R4
	LDV R14.1111, 0(14), <4>        # size:4
	BL OpenGLES.CallRegister        # size:4
	...
	ADD R8.1000, R3, R0		# ADD R8.1000, R0, R0 set_mark_2
	LDV R8.1111, 0(8), <4>          # size:4
	MVR R3.1000, R8.wyzw, <4>	# vsldoi 4, 8, 8, 12              # size:4
	NOP 9
	MVR R3.0111, R8.xxyz, <4>
	NOP 9
	MVR R4.1111, R3.xyzw, <4>	#end of  vsldoi 4, 8, 8, 12              # size:4
	MVR R3.1110, R4.yzww, <4>	# vsldoi 15, 4, 14, 4             # size:4
	NOP 9
	MVR R3.0001, R14.xyzx, <4>
	NOP 9
	MVR R15.1111, R3.xyzw, <4>	#end of  vsldoi 15, 4, 14, 4             # size:4
	ADDI R3, R2, 27		# ADDI r0, r1, 27 set_mark        # size:4
	ADD R16.1000, R3, R0		# ADD R16.1000, R0, R0 set_mark_2
	LDV R16.1111, 0(16), <4>        # size:4

...
.Ltmp0:
	...
	mfspr 30, 256
	mtspr 256, 3
	ADDI r29, r0, NormalMatrix.u.0.3@ha
	ADDI r28, r0, NormalMatrix.u.0.3@l
	BL OpenGLES.Start
	ADDI r3, r0, NormalMatrix.u.1.3@ha
	ADDI r4, r0, NormalMatrix.u.1.3@l
	ADDI r5, r0, NormalMatrix.u.2.3@ha
	ADDI r6, r0, NormalMatrix.u.2.3@l
	ADD 2.1000, 29, 28
	LD 2.0001, 3(2)
	LD 2.0010, 2(2)
	LD 2.0100, 1(2)
	...
	LD 4.0100, 1(4)
	LD 4.1000, 0(4)
	ADDI r29, r0, light_Pos.u.0.3@ha
	ADDI r28, r0, light_Pos.u.0.3@l
	BL OpenGLES.LoadAttribute3.rm_Normal.0
	ADDI r27, r0, eye_Pos.u.0.3@ha
	BL OpenGLES.CallRegister
	MVR r5.1111, r2.xyzw, <4>
	ADDI r26, r0, eye_Pos.u.0.3@l
	MVR r6.1111, r2.xyzw, <4>
	BL OpenGLES.MatrixTimesVector3.5
	ADDI r25, r0, diffuse_light.u.0.4@ha
	BL OpenGLES.Normalize3.1
	ADD 2.1000, 29, 28
	LD 2.0001, 3(2)
	LD 2.0010, 2(2)
	LD 2.0100, 1(2)
	LD 2.1000, 0(2)
	ADDI r29, r0, diffuse_light.u.0.4@l
	ADDI r28, r0, diffuse_material.u.0.4@ha
	BL OpenGLES.Normalize3.1
	ADD 3.1000, 27, 26
	LD 3.0001, 3(3)
	LD 3.0010, 2(3)
	LD 3.0100, 1(3)
	LD 3.1000, 0(3)
	ADDI r27, r0, diffuse_material.u.0.4@l
	ADDF r2.1111, r2.xyzw, r3.xyzw <4>
	ADDI r26, r0, ambient_light.u.0.4@ha
	BL OpenGLES.Normalize3.1
	ADDI r3, r0, ambient_light.u.0.4@l
	ADDI r4, r0, ambient_material.u.0.4@ha
	ADDI r5, r0, ambient_material.u.0.4@l
	ADD 29.1000, 25, 29
	LD 29.0001, 3(29)
	LD 29.0010, 2(29)
	LD 29.0100, 1(29)
...
# BB#1:                                 # %L1.T
	...
	MVR r3.1111, r2.xyzw, <4>
	BL OpenGLES.Dot3.2
	ADDI r29, r0, specular_light.u.0.4@ha
	ADDI r28, r0, specular_light.u.0.4@l
	BL OpenGLES.Max1.2
	ADDI r3, r0, specularExp.u.0.1@ha
	ADDI r4, r0, specular_material.u.0.4@ha
	ADDI r5, r0, specular_material.u.0.4@l
	ADD 6.1000, 29, 28
	LD 6.0001, 3(6)
	LD 6.0010, 2(6)
	LD 6.0100, 1(6)
	...
	LD 4.0100, 1(4)
	LD 4.1000, 0(4)
	LD r2, specularExp.u.0.1@l(3)
	MULF r2, r4, r6
	ADDF r2, r2, r26
	BL OpenGLES.Pow1.2
	BL OpenGLES.VectorTimesScalar4.2
	ADD 3.1000, 0, 27
	LD 3.0001, 3(3)
	LD 3.0010, 2(3)
	LD 3.0100, 1(3)
	LD 3.1000, 0(3)
	ADDF r3.1111, r3.xyzw, r2.xyzw <4>
	STV r3, 0, 27
	BL OpenGLES.VectorTimesScalar4.2
	ADD 3.1000, 0, 27
	LD 3.0001, 3(3)
...
.LBB0_2:                                # %L1.E
	...
	BL OpenGLES.LoadFloatVector1.0x4008000000000000.0x4008000000000000.0x4008000000000000.0x4008000000000000
	ADDI r28, r0, ModelViewMatrix1.u.3.4@l
	BL OpenGLES.LoadAttribute4.rm_Vertex.0
	ADDI r3, r0, ModelViewMatrix1.u.2.4@ha
	ADDI r4, r0, ModelViewMatrix1.u.2.4@l
	ADDI r5, r0, ModelViewMatrix1.u.1.4@ha
	ADDI r6, r0, ModelViewMatrix1.u.1.4@l
	ADDI r7, r0, ModelViewMatrix1.u.0.4@ha
	ADDI r8, r0, ModelViewMatrix1.u.0.4@l
	ADD 2.1000, 29, 28
	LD 2.0001, 3(2)
	LD 2.0010, 2(2)
	LD 2.0100, 1(2)
	...
	LD 5.0100, 1(5)
	LD 5.1000, 0(5)
	ADDI r29, r0, ModelViewMatrix.u.3.4@ha
	ADDI r28, r0, ModelViewMatrix.u.3.4@l
	BL OpenGLES.ChangeMatrix4.4.1
	ADDI r27, r0, ModelViewMatrix.u.2.4@ha
	BL OpenGLES.ChangeMatrix4.4.2
	ADDI r26, r0, ModelViewMatrix.u.2.4@l
	BL OpenGLES.ChangeMatrix4.4.3
	ADDI r25, r0, ModelViewMatrix.u.1.4@ha
	BL OpenGLES.ChangeMatrix4.4.4
	ADDI r24, r0, ModelViewMatrix.u.1.4@l
	BL OpenGLES.CallRegister
	MVR r7.1111, r2.xyzw, <4>
	ADDI r23, r0, ModelViewMatrix.u.0.4@ha
	MVR r3.1111, r2.xyzw, <4>
	...
	LD 5.0100, 1(5)
	LD 5.1000, 0(5)
	ADDI r29, r0, ProjectionMatrix.u.3.4@ha
	ADDI r28, r0, ProjectionMatrix.u.3.4@l
	BL OpenGLES.ChangeMatrix4.4.1
	ADDI r27, r0, ProjectionMatrix.u.2.4@ha
	BL OpenGLES.ChangeMatrix4.4.2
	ADDI r26, r0, ProjectionMatrix.u.2.4@l
	BL OpenGLES.ChangeMatrix4.4.3
	ADDI r25, r0, ProjectionMatrix.u.1.4@ha
	BL OpenGLES.ChangeMatrix4.4.4
	ADDI r24, r0, ProjectionMatrix.u.1.4@l
	BL OpenGLES.CallRegister
	MVR r7.1111, r2.xyzw, <4>
	ADDI r23, r0, ProjectionMatrix.u.0.4@ha
	MVR r3.1111, r2.xyzw, <4>
	MVR r4.1111, r2.xyzw, <4>
	MVR r5.1111, r2.xyzw, <4>
	MVR r6.1111, r2.xyzw, <4>
...
.Leh_frame_end0:
	...
	.weak	light_Pos.u.0.3
	.weak	eye_Pos.u.0.3
	.weak	diffuse_light.u.0.4
	.weak	diffuse_material.u.0.4
	.weak	ambient_light.u.0.4
	.weak	ambient_material.u.0.4
	.weak	specular_light.u.0.4
	.weak	specular_material.u.0.4
	...
	.weak	OpenGLES.MatrixTimesVector3.5
	.weak	OpenGLES.Normalize3.1
	.weak	OpenGLES.Dot3.2
	.weak	OpenGLES.Max1.2
	.weak	OpenGLES.Pow1.2
	.weak	OpenGLES.VectorTimesScalar4.2
	.weak	OpenGLES.LoadFloatVector1.0x4008000000000000.0x4008000000000000.0x4008000000000000.0x4008000000000000

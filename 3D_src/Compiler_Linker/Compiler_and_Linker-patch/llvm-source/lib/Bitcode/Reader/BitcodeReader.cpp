...
static GlobalValue::LinkageTypes GetDecodedLinkage(unsigned Val) {
  ...
  /* Dondum 2009-11-02 */
  case 16: return GlobalValue::UniformLinkage;
  case 17: return GlobalValue::AttributeLinkage;
  case 18: return GlobalValue::VaryingLinkage;
  ...
  while (1) {
	...
	break;
      ...
      */
      ...
      //yakola
      signed int i = Record[0];
      if(i < 0){
        //printf("Matrix NumElts=%d\n",Record[0]);
        ResultTy = VectorType::getMatrix(getTypeByID(Record[1], true),
                                   -i, true);
        //dyn_cast<VectorType>(ResultTy)->setIsMatrix();
      }else{
        //printf("Vector NumElts=%d\n",Record[0]);
        ResultTy = VectorType::get(getTypeByID(Record[1], true), Record[0]);
      }
      // end

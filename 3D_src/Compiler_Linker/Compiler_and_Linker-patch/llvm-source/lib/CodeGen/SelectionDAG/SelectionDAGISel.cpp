...
//Kaymon This part is to optimze DAG. If you need to find the where the DAG change, just look here.
void SelectionDAGISel::CodeGenAndEmitDAG() {
  ...
  if (Changed) {
    ...
    // Run the DAG combiner in post-type-legalize mode.
    {
      NamedRegionTimer T("DAG Combining after legalize types", GroupName,
                         TimePassesIsEnabled);
      //dbgs() << "****************************before DAG Combining after legalize types\n";
      //CurDAG->dump();
      //dbgs() << "****************************before DAG Combining after legalize types\n";
      CurDAG->Combine(NoIllegalTypes, *AA, OptLevel);
      //dbgs() << "****************************after DAG Combining after legalize types\n";
      //CurDAG->dump();
      //dbgs() << "****************************after DAG Combining after legalize types\n";
    }
...

  {
    ...
    //dbgs() << "****************************before Vector Legalization\n";
    //CurDAG->dump();
    //dbgs() << "****************************before Vector Legalization\n";
    Changed = CurDAG->LegalizeVectors();
    //dbgs() << "****************************after Vector Legalization\n";
    //CurDAG->dump();
    //dbgs() << "****************************after Vector Legalization\n";
  }
  ...
  if (Changed) {
    {
      ...
      //dbgs() << "****************************before Type Legalization 2\n";
      //CurDAG->dump();
      //dbgs() << "****************************before Type Legalization 2\n";
      CurDAG->LegalizeTypes();
      //dbgs() << "****************************after Type Legalization 2\n";
      //CurDAG->dump();
      //dbgs() << "****************************after Type Legalization 2\n";
    }
    ...
    // Run the DAG combiner in post-type-legalize mode.
    {
      NamedRegionTimer T("DAG Combining after legalize vectors", GroupName,
                         TimePassesIsEnabled);
      //dbgs() << "****************************before DAG Combining after legalize vectors\n";
      //CurDAG->dump();
      //dbgs() << "****************************before DAG Combining after legalize vectors\n";
      CurDAG->Combine(NoIllegalOperations, *AA, OptLevel);
      //dbgs() << "****************************after DAG Combining after legalize vectors\n";
      //CurDAG->dump();
      //dbgs() << "****************************after DAG Combining after legalize vectors\n";
    }
...

  {
    ...
    //CurDAG->viewGraph("before dag legalization");
    CurDAG->Legalize(OptLevel);
    //CurDAG->viewGraph("after dag legalization");

  }

  //dbgs() << "****************************after DAG Legalization\n";
  //CurDAG->dump();
  //dbgs() << "****************************after DAG Legalization\n";

  DEBUG(dbgs() << "Legalized selection DAG:\n"; CurDAG->dump());

  //dbgs() << "****************************before DAG Combining 2\n";
  //CurDAG->dump();
  //dbgs() << "****************************before DAG Combining 2\n";
  ...
  //dbgs() << "****************************before doinstruction  selection DAG:\n";
  //CurDAG->dump();
  //dbgs() << "****************************before doinstruction  selection DAG:\n";
  ...
  //dbgs() << "****************************after doinstruction  selection DAG:\n";
  //CurDAG->dump();
  //dbgs() << "****************************after doinstruction  selection DAG:\n";
...
void SelectionDAGISel::SelectAllBasicBlocks(const Function &Fn,const MachineFunction &MF) {

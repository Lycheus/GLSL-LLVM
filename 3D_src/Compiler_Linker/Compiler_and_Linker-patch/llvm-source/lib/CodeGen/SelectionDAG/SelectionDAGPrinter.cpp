...
// This code is only for debugging! //If you want to show the picture. you'd like to comment the this flag. It will output the ps file. If you can't see the detail of the picture,I suggest you use the inkscape 
//to see the picture. Kaymon
//#ifndef NDEBUG

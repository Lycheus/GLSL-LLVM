...
bool LowerSubregsInstructionPass::LowerCopy(MachineInstr *MI) {
  ...
  //cout<<"Copy2 exit\n";
  //cout.flush();
  //cout<<"Dst: "<<DstMO.getReg()<<" src:"<< SrcMO.getReg()<<"\n"; //Kaymon see the copy's dst and src register. see which one can be acceptable.
  //cout<<"src iskill: "<<SrcMO.isKill()<<" "<< DstMO.isKill()<<" \n";

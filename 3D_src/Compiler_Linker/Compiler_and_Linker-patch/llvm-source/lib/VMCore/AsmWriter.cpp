...
static void PrintLinkage(GlobalValue::LinkageTypes LT,
  ...
  /* Dondum 2009-11-02*/
  case GlobalValue::UniformLinkage:       Out << "Uniform ";        break;
  case GlobalValue::AttributeLinkage:     Out << "Attribute ";      break;
  case GlobalValue::VaryingLinkage:       Out << "Varying ";        break;

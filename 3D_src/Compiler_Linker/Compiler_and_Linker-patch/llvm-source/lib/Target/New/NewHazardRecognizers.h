//===-- NewHazardRecognizers.h - PowerPC Hazard Recognizers -----*- C++ -*-===//
//
...
/// NewHazardRecognizer970 - This class defines a finite state automata that
...
class NewHazardRecognizer970 : public ScheduleHazardRecognizer {
...
public:
  NewHazardRecognizer970(const TargetInstrInfo &TII);
...
private:
  ...
  /// pipeline.
  NewII::New970_Unit GetInstrType(unsigned Opcode,

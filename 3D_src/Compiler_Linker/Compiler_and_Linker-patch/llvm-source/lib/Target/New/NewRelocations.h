//===- NewRelocations.h - New32 Code Relocations ----------------*- C++ -*-===//
//
...
#ifndef New32RELOCATIONS_H
#define New32RELOCATIONS_H

#include "llvm/CodeGen/MachineRelocation.h"

// Hack to rid us of a New pre-processor symbol which is erroneously
// defined in a PowerPC header file (bug in Linux/New)
#ifdef New
#undef New
#endif

//===-- NewMachineFunctionInfo.h - Private data used for PowerPC --*- C++ -*-=//
//
...
#ifndef New_MACHINE_FUNCTION_INFO_H
#define New_MACHINE_FUNCTION_INFO_H

#include "llvm/CodeGen/MachineFunction.h"

namespace llvm {

/// NewFunctionInfo - This class is derived from MachineFunction private
/// PowerPC target-specific information for each MachineFunction.
class NewFunctionInfo : public MachineFunctionInfo {
private:
...
public:
  explicit NewFunctionInfo(MachineFunction &MF) 

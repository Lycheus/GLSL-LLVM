//=====-- NewSubtarget.h - Define Subtarget for the New -------*- C++ -*--====//
//
...
class NewSubtarget : public TargetSubtarget {
protected:
...
public:
  ...
  ///
  NewSubtarget(const std::string &TT, const std::string &FS, bool is64Bit);
  ...
  const char *getTargetDataString() const {
    ...
    return isNew64() ? "E-p:64:64-f64:64:64-i64:64:64-f128:64:128-n32:64"
                     : "E-p:32:32-f64:32:64-i64:32:64-f128:64:128-n32";
  }

  /// isNew64 - Return true if we are generating code for 64-bit pointer mode.
  ///
  bool isNew64() const { return IsNew64; }

//===-- NewISelLowering.h - New32 DAG Lowering Interface --------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the interfaces that New uses to lower LLVM code into a
// selection DAG.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_TARGET_POWERPC_New32ISELLOWERING_H
#define LLVM_TARGET_POWERPC_New32ISELLOWERING_H
...
namespace llvm {
  namespace NewISD {
    enum NodeType {
      ...
      /// VPERM - The New VPERM Instruction.
      ///
      VPERM,
      ...
      /// This instruction is lowered in NewRegisterInfo::eliminateFrameIndex to
      ...
      /// These nodes represent the 32-bit New shifts that operate on 6-bit
      ...
      /// New::BLE), DESTBB is the destination block to branch to, and INFLAG is
      ...
      /// LARX = This corresponds to New l{w|d}arx instrcution: load and
      /// reserve indexed. This is used to implement atomic operations.
      LARX,

      /// STCX = This corresponds to New stcx. instrcution: store conditional
  ...
  class NewTargetLowering : public TargetLowering {
    const NewSubtarget &NewSubTarget;

  public:
    explicit NewTargetLowering(NewTargetMachine &TM);
...
#endif   // LLVM_TARGET_POWERPC_New32ISELLOWERING_H

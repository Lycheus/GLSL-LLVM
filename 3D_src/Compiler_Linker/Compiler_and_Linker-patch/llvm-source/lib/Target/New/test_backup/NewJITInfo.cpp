//===-- NewJITInfo.cpp - Implement the JIT interfaces for the PowerPC -----===//
//
...
extern "C" void New32CompilationCallback();
extern "C" void New64CompilationCallback();
...
asm(
    ".text\n"
    ".align 2\n"
    ".globl _New32CompilationCallback\n"
"_New32CompilationCallback:\n"
...
#elif defined(__New__) && !defined(__ppc64__)
// Linux & FreeBSD / New 32 support
...
asm(
    ".text\n"
    ".align 2\n"
    ".globl New32CompilationCallback\n"
"New32CompilationCallback:\n"
...
asm(
    ".text\n"
    ".align 2\n"
    ".globl _New64CompilationCallback\n"
"_New64CompilationCallback:\n"
    // Make space for 8 ints r[3-10] and 13 doubles f[1-13] and the 
    // FIXME: need to save v[0-19] for altivec?
    // Set up a proper stack frame
    // Layout
...
#else
void New64CompilationCallback() {
  llvm_unreachable("This is not a power pc, you can't execute this!");
}
#endif

extern "C" void *NewCompilationCallbackC(unsigned *StubCallAddrPlus4,
...
NewJITInfo::getLazyResolverFunction(JITCompilerFn Fn) {
  JITCompilerFunction = Fn;
  return is64Bit ? New64CompilationCallback : New32CompilationCallback;
}

TargetJITInfo::StubLayout NewJITInfo::getStubLayout() {
...
void *NewJITInfo::emitFunctionStub(const Function* F, void *Fn,
                                   JITCodeEmitter &JCE) {
  // If this is just a call to an external function, emit a branch instead of a
  // call.  The code is the same except for one bit of the last instruction.
  if (Fn != (void*)(intptr_t)New32CompilationCallback && 
      Fn != (void*)(intptr_t)New64CompilationCallback) {
...
void NewJITInfo::relocate(void *Function, MachineRelocation *MR,
                          unsigned NumRelocs, unsigned char* GOTBase) {
  for (unsigned i = 0; i != NumRelocs; ++i, ++MR) {
    unsigned *RelocPos = (unsigned*)Function + MR->getMachineCodeOffset()/4;
    intptr_t ResultPtr = (intptr_t)MR->getResultPointer();
    switch ((New::RelocationType)MR->getRelocationType()) {
    default: llvm_unreachable("Unknown relocation type!");
    case New::reloc_pcrel_bx:
    ...
    case New::reloc_pcrel_bcx:
      ...
      *RelocPos |= (ResultPtr & ((1 << 14)-1))  << 2;
      break;
    case New::reloc_absolute_high:     // high bits of ref -> low 16 of instr
    case New::reloc_absolute_low: {    // low bits of ref  -> low 16 of instr
      ResultPtr += MR->getConstantVal();

      // If this is a high-part access, get the high-part.
      if (MR->getRelocationType() == New::reloc_absolute_high) {
    ...
    case New::reloc_absolute_low_ix: {  // low bits of ref  -> low 14 of instr
      ResultPtr += MR->getConstantVal();
      // Do the addition then mask, so the addition does not overflow the 16-bit
      // immediate section of the instruction.
...
void NewJITInfo::replaceMachineCodeForFunction(void *Old, void *New) {

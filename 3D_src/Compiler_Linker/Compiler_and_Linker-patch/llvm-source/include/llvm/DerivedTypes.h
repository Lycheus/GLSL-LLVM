...
class VectorType : public SequentialType {
 ...
 //yakola
  ...
  //yakola
  VectorType(const Type *ElType, unsigned NumEl, bool IsMatrix);
...
public:
  ...
  //yakola - The method to create "Matrix" type
  static VectorType *getMatrix(const Type *ElementType, unsigned NumElements,
                               bool isMatrix);
  ...
  // yakola - Return the NumElements(column) because we assume all matrix is 
  // square matrix
  //
  //unsigned getHeight(){
  //  return NumElements;

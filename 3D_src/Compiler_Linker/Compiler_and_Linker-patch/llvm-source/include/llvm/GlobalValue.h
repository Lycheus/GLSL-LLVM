...
public:
  ...
  enum LinkageTypes {
    ...
    //yakola - Add linkage
    AttributeLinkage,   ///< Attribute for LLVM-IR
    UniformLinkage,     ///< Uniform for LLVM-IR
    VaryingLinkage,     ///< Varying for LLVM-IR
    HighpLinkage
    //end
  };
...
public:
  ...
  //yakola - Add function to check the extended linkage type.
  bool hasUniformLinkage() const { return Linkage == UniformLinkage; }
  bool hasVaryingLinkage() const { return Linkage == VaryingLinkage; }
  bool hasAttributeLinkage() const { return Linkage == AttributeLinkage; }
  //end

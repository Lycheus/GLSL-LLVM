...
** "AS IS" basis, with ALL EXPRES#include <time.h>S AND IMPLIED WARRANTIES AND CONDITIONS
...
** was created using the OpenGL(R) versc_perfo.GM_timeion 1.2.1 Sample Implementation
** published by SGI, but has not #include <time.h>been independently verified as being
...
/*! \file gl.h
   \brief The functions is about the basic gl gunction operation and definition.
*/

#define DUMP_FRAME_BUFFER 0
#define FRAME_BUFFER_BIT 0 //if DUMP_FRAME_BUFFER=0, FRAME_BUFFER_BIT can't be 1
...
typedef unsigned * GLsizeiptr;
typedef unsigned * GLintptr;
typedef unsigned char GLchar;

/*#ifdef clocktest
	typedef unsigned long long GLlong;
#endif*/
...
/**
 * BlendColor, BlendFunc
 * Add by Robarter @ 2012/08/26
 * (ref glext.h by Google)
 */
...
/* Shader Source*/  //add by skald sian-jyun 2012/04/18
...
//************************************************
//       Define "Performance Check Extension"
//************************************************
#define GL_PERFORMANCE_CHECK              0x9000

#define GL_ALL                            0x9100

#define GL_TOTAL_FRAMES                   0x9001

#define GL_PRIMITIVE                      0x9010
//#define GL_N_OF_PRIMITIVE                 0x9010
//#define GL_N_OF_POINTS                    0x9002
//#define GL_N_OF_TRIANGLES                 0x9003
//#define GL_N_OF_P_TRIANGLES               0x9004
//#define GL_N_OF_PIXELS                    0x9005
//#define GL_N_OF_P_PIXELS                  0x9006

#define GL_PROCESSED_TIME                 0x9011
//#define GL_TOTAL_P_TIME                   0x9007
//#define GL_GEOMETRY_P_TIME                0x9008
//#define GL_GEOMETRY_LIGHTING_P_TIME       0x9009
//#define GL_PIXEL_P_TIME                   0x900A

#define GL_GENERAL                        0x9012
//#define GL_FPS                            0x900B
//#define GL_TRIANGLES_PER_SEC              0x900C
//#define GL_PIXEL_PER_SEC                  0x900D

#define GL_PER_FRAGMENT_UTILITY_RATE      0x9013

#define GL_BUFFER_W_R                     0x9014

#define GL_HISTORY_OF_FUNCTION            0x9015

#define GL_LINE_STIPPLE			  0x9016
...
/** glBlendColor. add by Robarter@2012/08/23 */
GLAPI void APIENTRY glBlendColor(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha);
/** glBlendEquation. add by Robarter@2012/08/27 */
GLAPI void APIENTRY glBlendEquation(GLenum mode);
/** glBlendEquationSeparate. add by Robarter@2012/08/29 */
GLAPI void APIENTRY glBlendEquationSeparate(GLenum modeRGB, GLenum modeAlpha);
GLAPI void APIENTRY glBlendFunc (GLenum sfactor, GLenum dfactor);
/** glBlendFuncSeparate. add by Robarter@2012/08/28 */
GLAPI void APIENTRY glBlendFuncSeparate (GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha);
/** glCheckFramebufferStatus. add by Robarter@2012/09/09 */
...
GLAPI void APIENTRY glGetFloatv (GLenum pname, GLfixed *params);
...
GLAPI void APIENTRY glLineWidth (GLfixed param);
...
//*************************************************
//  Define "Performance Check Extension function"
//*************************************************
GLAPI void APIENTRY glSetIP(char* ipaddr, GLint port);
GLAPI void APIENTRY glRecordFrame(GLint number);
GLAPI void APIENTRY glPerformanceReport(char* name);
//fixed by sheng-chih
//GLAPI void APIENTRY glPerformanceReportNetwork(GLvoid);
//end fixed
GLAPI void APIENTRY glRecordEnable(GLenum check);
GLAPI void APIENTRY glRecordDisable(GLenum check);

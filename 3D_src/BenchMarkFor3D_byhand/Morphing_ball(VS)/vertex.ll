...
L2.E:
L1.E:
	%20 = load <3 x 3 float>* @NormalMatrix.u.0.3, align 12
	%21 = load <3 x 3 float>* @NormalMatrix.u.1.3, align 12
	%22 = load <3 x 3 float>* @NormalMatrix.u.2.3, align 12
...
L3.E:
	...
	%54 = load <4 x 4 float>* @ModelViewMatrix.u.0.4, align 16
	%55 = load <4 x 4 float>* @ModelViewMatrix.u.1.4, align 16
	%56 = load <4 x 4 float>* @ModelViewMatrix.u.2.4, align 16
	%57 = load <4 x 4 float>* @ModelViewMatrix.u.3.4, align 16
	...
	%64 = load <4 x 4 float>* @ProjectionMatrix.u.0.4, align 16
	%65 = load <4 x 4 float>* @ProjectionMatrix.u.1.4, align 16
	%66 = load <4 x 4 float>* @ProjectionMatrix.u.2.4, align 16
	%67 = load <4 x 4 float>* @ProjectionMatrix.u.3.4, align 16

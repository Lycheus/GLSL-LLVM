...
float total=0.0,total1=0.0,total2=0.0, norm1=0.0,norm2=0.0,norm3=0.0 ,binorm1=0.0,binorm2=0.0,binorm3=0.0, tg1=0.0,tg2=0.0,tg3=0.0;
  for(int i=0;i<num;i++){
    ...
    norm1= norm1 + (dirx[i]*ami[i]*(2.0*pi/wl[i])*cos(2.0*pi/wl[i]*(dirx[i]*v.x+diry[i]*v.y)+s*(2.0*pi*time/wl[i])));
    norm2= norm2 + (dirx[i]*ami[i]*(2.0*pi/wl[i])*cos(2.0*pi/wl[i]*(diry[i]*v.x+diry[i]*v.y)+s*(2.0*pi*time/wl[i])));
    norm3= norm3 + (qq[i]*ami[i]*(2.0*pi/wl[i])*sin(2.0*pi/wl[i]*(dirx[i]*v.x+diry[i]*v.y)+s*(2.0*pi*time/wl[i])));
    
    binorm1=binorm1 + (qq[i]*dirx[i]*dirx[i]*ami[i]*(2.0*pi/wl[i])*sin(2.0*pi/wl[i]*(dirx[i]*v.x+diry[i]*v.y)+s*(2.0*pi*time/wl[i])));
    binorm2=binorm2 + (qq[i]*dirx[i]*diry[i]*ami[i]*(2.0*pi/wl[i])*sin(2.0*pi/wl[i]*(dirx[i]*v.x+diry[i]*v.y)+s*(2.0*pi*time/wl[i])));
    binorm3=binorm3 + (dirx[i]*ami[i]*(2.0*pi/wl[i])*cos(2.0*pi/wl[i]*(dirx[i]*v.x+diry[i]*v.y)+s*(2.0*pi*time/wl[i])));

    tg1=tg1 + (qq[i]*dirx[i]*diry[i]*ami[i]*(2.0*pi/wl[i])*sin(2.0*pi/wl[i]*(dirx[i]*v.x+diry[i]*v.y)+s*(2.0*pi*time/wl[i])));
    tg2=tg2 + (qq[i]*diry[i]*diry[i]*ami[i]*(2.0*pi/wl[i])*sin(2.0*pi/wl[i]*(dirx[i]*v.x+diry[i]*v.y)+s*(2.0*pi*time/wl[i])));
    tg3=tg3 + (diry[i]*ami[i]*(2.0*pi/wl[i])*cos(2.0*pi/wl[i]*(dirx[i]*v.x+diry[i]*v.y)+s*(2.0*pi*time/wl[i])));
  }
  v.x = v.x+total;
  v.y = v.y+total1;
  v.z = total2;

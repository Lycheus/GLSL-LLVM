/****************************************************************************
** PaletteEditorAdvanced meta object code from reading C++ file 'paletteeditoradvancedimpl.h'
**
** Created: Fri Mar 20 16:26:07 2015
...
QMetaObject* PaletteEditorAdvanced::staticMetaObject()
{
    ...
    static const QUMethod slot_5 = {"onChoosePixmap", 0, 0 };
    static const QUParameter param_slot_6[] = {
	{ 0, &static_QUType_bool, 0, QUParameter::In }
    };
    static const QUMethod slot_6 = {"onToggleBuildEffects", 1, param_slot_6 };
    static const QUParameter param_slot_7[] = {
	{ 0, &static_QUType_bool, 0, QUParameter::In }
    };
    static const QUMethod slot_7 = {"onToggleBuildInactive", 1, param_slot_7 };
    static const QUParameter param_slot_8[] = {
	{ 0, &static_QUType_bool, 0, QUParameter::In }
    };
    static const QUMethod slot_8 = {"onToggleBuildDisabled", 1, param_slot_8 };
	...
	{ "onChoosePixmap()", &slot_5, QMetaData::Protected },
	{ "onToggleBuildEffects(bool)", &slot_6, QMetaData::Protected },
	{ "onToggleBuildInactive(bool)", &slot_7, QMetaData::Protected },
	{ "onToggleBuildDisabled(bool)", &slot_8, QMetaData::Protected }
    };
...
bool PaletteEditorAdvanced::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 5: onChoosePixmap(); break;
    case 6: onToggleBuildEffects((bool)static_QUType_bool.get(_o+1)); break;
    case 7: onToggleBuildInactive((bool)static_QUType_bool.get(_o+1)); break;
    case 8: onToggleBuildDisabled((bool)static_QUType_bool.get(_o+1)); break;
    default:

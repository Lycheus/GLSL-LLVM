/****************************************************************************
** PreviewWidget meta object code from reading C++ file 'previewwidgetimpl.h'
**
...
QMetaObject* PreviewWidget::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
    QMetaObject* parentObject = PreviewWidgetBase::staticMetaObject();
...
void* PreviewWidget::qt_cast( const char* clname )
{
	...
	return this;
    return PreviewWidgetBase::qt_cast( clname );
}

bool PreviewWidget::qt_invoke( int _id, QUObject* _o )
{
    return PreviewWidgetBase::qt_invoke(_id,_o);
}

bool PreviewWidget::qt_emit( int _id, QUObject* _o )
{
    return PreviewWidgetBase::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool PreviewWidget::qt_property( int id, int f, QVariant* v)
{
    return PreviewWidgetBase::qt_property( id, f, v);
}

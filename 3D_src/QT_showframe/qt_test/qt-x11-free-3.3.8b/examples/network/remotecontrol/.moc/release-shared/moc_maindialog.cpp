...
static QMetaObjectCleanUp cleanUp_MainDialog( "MainDialog", &MainDialog::staticMetaObject );
...
bool MainDialog::qt_property( int id, int f, QVariant* v)
{
    return QDialog::qt_property( id, f, v);
}

bool MainDialog::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES

...
/*
 *  Constructs a MainDialog as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  TRUE to construct a modal dialog.
 */
MainDialog::MainDialog( QWidget* parent, const char* name, bool modal, WFlags fl )
      ...
      image0( (const char **) image0_data )
{
    ...
    MainDialogLayout = new QVBoxLayout( this, 11, 6, "MainDialogLayout"); 
    ...
    MainDialogLayout->addWidget( TextLabel2 );

    image = new QLabel( this, "image" );
    image->setPixmap( image0 );
    image->setScaledContents( FALSE );
    image->setAlignment( int( QLabel::AlignCenter ) );
    MainDialogLayout->addWidget( image );

    description = new QLabel( this, "description" );
    description->setSizePolicy( QSizePolicy( (QSizePolicy::SizeType)5, (QSizePolicy::SizeType)0, 0, 0, description->sizePolicy().hasHeightForWidth() ) );
    QFont description_font(  description->font() );
    description_font.setPointSize( 26 );
    description->setFont( description_font ); 
    description->setAlignment( int( QLabel::AlignCenter ) );
    MainDialogLayout->addWidget( description );
    Spacer2_2 = new QSpacerItem( 20, 20, QSizePolicy::Minimum, QSizePolicy::Expanding );
    MainDialogLayout->addItem( Spacer2_2 );
    ...
    MainDialogLayout->addLayout( Layout2 );
    languageChange();
    resize( QSize(273, 263).expandedTo(minimumSizeHint()) );
...
void MainDialog::languageChange()
{
    ...
    TextLabel2->setText( tr( "If you start another instance of this application, you can use that instance to control this one." ) );
    description->setText( tr( "The Qt logo" ) );
